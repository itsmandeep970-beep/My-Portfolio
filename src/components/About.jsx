      ...
      <div className="section-wrap">
        <div className="about-grid fade-up">
          ...
          <div className="about-text">
            ...
            <p>I am a passionate BCA student and aspiring Full Stack JavaScript Developer from Haryana.</p>
            <p>I enjoy creating responsive, user-friendly websites and continuously learning new technologies.</p>
